...
I have extensive, production-level JavaScript and frontend experience, centered on this personal website. Over two years of active development, I've built and rebuilt it through four distinct architectural eras - most recently a full agent-first rewrite using Next.js 15, React 18, TypeScript, Clerk auth, and Neon Postgres. The current site includes streaming API responses via Server-Sent Events, agentic tool loops using the Claude Agent SDK, complex async state management, CSS Modules component architecture, and a live agent that can search my experience, analyze job descriptions, and schedule meetings. I also built DocWow (a healthcare AI application) in Next.js with React-PDF, citation UX, and Lambda/S3 backends; and integrated QuickSight dashboards into Next.js customer portals at Thoughtful via iFrames. Frontend development is not a gap for me - it is one of the primary mediums I use to ship production AI systems.