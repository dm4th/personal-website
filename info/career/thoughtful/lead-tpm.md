...
Transformations Care Network was the clearest example from that window. TCN is a behavioral health provider operating across five states, backed by Shore Capital Partners, with active expansion into additional states driven by Shore Capital's growth mandate. They came to Thoughtful because their staff couldn't keep pace with eligibility and benefits verification volume as the expansion accelerated. I was the solo lead on the build start-to-finish, including writing portions of the agent code myself: an eligibility verification agent that was covering 80–90% of their benefits checks by go-live. It was one of the few implementations we delivered profitably end-to-end.

The Shore Capital relationship extended beyond the project itself. We structured referral credits into the contract: TCN was incentivized to introduce us to other Shore Capital portfolio companies if they could vouch for the delivery. By the time the TCN build wrapped, we were in late-stage discussions with several other Shore Capital holdings as a direct result. That was a different kind of sales motion — not a single company evaluating a product, but a PE firm developing a pattern of adoption across a portfolio. TCN was also my first implementation I owned entirely on my own, which made it formative in a way the later, larger deals weren't.
